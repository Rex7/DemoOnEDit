package com.example.regis.demoonedit;
 ...
 */
public class Frontend  extends AppCompatActivity implements AdapterView.OnItemSelectedListener{
    ...
    public void Submit(View v) {
        ...
        DatabaseHandler h = new DatabaseHandler(this,null,null,1);
        h.register(s);
    }
